...
const AppImage = memo(function AppImage({
    ...
    sizes,
    onClick,
    fallbackSrc = 'https://plus.unsplash.com/premium_photo-1664301420258-06811f6c1b4a?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8JUMzJUE5bCVDMyVBOHZlcyUyMGVuJTIwY2xhc3NlfGVufDB8fDB8fHww',
    loading = 'lazy',
    unoptimized = false,
    ...props
}: AppImageProps) {
